...
public class JDlgUsuarios extends javax.swing.JDialog {
    ...
    public JDlgUsuarios(java.awt.Frame parent, boolean modal) {
        ...
        tools.Util.habilitar(false, jTxtCodigo, jTxtNome, jTxtApelido, jFmtCpf, jFmtDataDeNascimento,
                jPwfSenha, jCboNivel, jChbAtivo, jBtnCancelar, jBtnConfirmar);
        tools.Util.habilitar(true, jBtnIncluir, jBtnAlterar, jBtnExcluir, jBtnPesquisar);
    ...
    public RsUsuarios viewBean() {
        RsUsuarios usuarios = new RsUsuarios();
        usuarios.setRsIdusuarios(tools.Util.strInt(jTxtCodigo.getText()));
        usuarios.setRsNome(jTxtNome.getText());
        usuarios.setRsApelido(jTxtApelido.getText());
        usuarios.setRsCpf(jFmtCpf.getText());
        usuarios.setRsNasc(tools.Util.strData(jFmtDataDeNascimento.getText()));
        usuarios.setRsSenha(jPwfSenha.getText());
        usuarios.setRsNivel(jCboNivel.getSelectedIndex());
        usuarios.setRsAtivo( jChbAtivo.isSelected() == true ? "S" : "N");
...
//        }
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        // TODO add your handling code here:
        tools.Util.habilitar(true, jTxtCodigo, jTxtNome, jTxtApelido, jFmtCpf, jFmtDataDeNascimento,
                jPwfSenha, jCboNivel, jChbAtivo, jBtnCancelar, jBtnConfirmar);
        tools.Util.habilitar(false, jBtnIncluir, jBtnAlterar, jBtnExcluir, jBtnPesquisar);
        tools.Util.limp(jTxtCodigo, jTxtNome, jTxtApelido, jFmtCpf, jFmtDataDeNascimento,
    ...
    private void jBtnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirActionPerformed
        ...
        if (Util.perguntar("Deseja excluir o registro?") == true) {
            ...
            tools.Util.msg("Exclusão cancelada.");
        }
